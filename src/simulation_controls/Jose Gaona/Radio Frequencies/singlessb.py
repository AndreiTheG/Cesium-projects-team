...
class singlessb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "singlessb")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, [1+0j, 1+0j, 1+0j], 0.0, samp_rate)
        ...
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_throttle2_0, 0))
...
def main(top_block_cls=singlessb, options=None):
