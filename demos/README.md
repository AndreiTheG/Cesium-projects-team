...
│ ├── README.md → Documentation for this directory.
│
├── 📂 screenshots/ -> Contains screenshots with presentations of team members' Cesium projects.
│ ├── 📂 Ahmed Adel/ -> Scrrenshot(s) schowcasing Ahmed Adel’s project.
│ ├── 📂 Andrei Gheorghe/ -> Scrrenshot(s) schowcasing Andrei Gheorghe’s project.
│ ├── 📂 Rafid Sorker/ -> Scrrenshot(s) schowcasing Andrei Gheorghe’s project.
│ ├── README.md → Documentation for this directory.
│
├── README.md → Documentation for this directory.
...
# Application Videos and screenshots:
...
- **Truck's backward reversed movement**
- **Objects Gravitation**
- **Drone's clockwise and counterclockwise rotation**
